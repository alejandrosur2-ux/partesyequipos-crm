...
export default async function MachineProbePage({
  params,
}: {
  ...
  try {
    ...
    return (
      <div className="p-6 space-y-4">
        <h1 className="text-2xl font-semibold">Máquina (sonda)</h1>
    ...
    console.error("Probe /machines/[id] error:", e);
    return (
      <div className="p-6 space-y-4">
        <h1 className="text-xl font-semibold">Error en sonda</h1>
